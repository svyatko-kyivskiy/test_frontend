class CustomHighchartsWidgetCtrl {
    ...
    $onInit() {
        ...
        this.chartOptions = this.dataFactory.getHighchartsBaseConfig(this.columnHeaders[0], this.rowsData);
    }
}

CustomHighchartsWidgetCtrl.$inject = ['$rootScope', '$timeout', '$scope', 'dataFactoryHighcharts']
